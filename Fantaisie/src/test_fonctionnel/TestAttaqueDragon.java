...
public class TestAttaqueDragon {
	public static void main(String[] args) {
		...
		// Tristan subit une violente attaque, mais il parvient à se relever.
		// Dragon noir crache une boule de feu sur Tristan
		...
		// Perceval subit une violente attaque, mais il parvient à se relever.
		// Dragon noir crache une boule de feu sur Perceval
		...
		// Lancelot subit une violente attaque, mais il parvient à se relever.
		// Dragon noir crache une boule de feu sur Lancelot
		...
		// Hector subit une violente attaque, mais il parvient à se relever.
		// Dragon noir crache une boule de feu sur Hector
		...
		// Yvain subit une violente attaque, mais il parvient à se relever.
		// Dragon noir crache une boule de feu sur Yvain
